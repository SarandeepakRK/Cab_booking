            ...
            <div class="container padd-lr0 marg-lg-t100 marg-lg-b100 marg-xs-t0 marg-xs-b0">
                <div class="row">
					...
					<th>Share</th>
											...
											$query = "SELECT * FROM booking WHERE btype='Share' AND pass<'3'";
					        ...
					        <tr>
							  ...
							  <form action='conf-sharing.php' method='post'>
							  <input type="hidden" name="bid" value="<?php echo $row['bid'];?>">
							  <input type="hidden" name="uid" value="<?php echo $uid; ?>">
							  <input type="hidden" name="status" value="Waiting">
					          <td><input type="submit" name="submit"  value="Share Now"></td>
							  </form>
					        </tr>
					        <?php 
											} 
